...
extra_args = --quiet --noinclude-qt-translations --include-package=qa_orbit_desktop --include-package=runtime.qa_orbit_agent --include-package=browser_use --include-package=keyring.backends
